...
// extracted by mini-css-extract-plugin
module.exports = {"Actions":"Common_Actions__2KkrQ","Container":"Common_Container__qvWDW","Loading":"Common_Loading__1S17p","Message":"Common_Message__1KtI1"};
...
var esm_history = __webpack_require__(246);
...
var Router = __webpack_require__(560);
...
var toConsumableArray = __webpack_require__(104);
...
var react_table_es = __webpack_require__(245);
...
var components_Tooltip = __webpack_require__(105);
...
var normalizr_es = __webpack_require__(101);

// EXTERNAL MODULE: ./node_modules/redux-form/es/SubmissionError.js + 1 modules
var SubmissionError = __webpack_require__(248);
...
// Views
// Utils
var actions_createValidator=function createValidator(_ref){var address=_ref.address,deposit=_ref.deposit,hash=_ref.hash,node=_ref.node;return function(dispatch,getState,_ref2){var account=_ref2.account,web3=_ref2.web3;dispatch({type:CREATE_VALIDATOR_REQUEST});return new Promise(function(resolve,reject){var value=web3.utils.toWei(deposit,'ether');var formattedHash="0x".concat(hash.replace(/^(0[xX]{1})?/,''));var formattedNode="0x".concat(node.replace(/^(0[xX]{1})?/,''));var formattedAddress="0x".concat(address.replace(/^(0[xX]{1})?/,''));account.methods.addInitialDeposit(formattedHash,formattedNode,formattedAddress).send({value:value,from:window.ethereum.selectedAddress}).on('receipt',function(){return dispatch(actions_updateValidator(hash,{isFetching:false}));}).on('error',reject).on('transactionHash',function(){resolve();dispatch({type:CREATE_VALIDATOR_SUCCESS,hash:hash,payload:{address:formattedAddress,deposit:convertDeposit(deposit),hash:formattedHash,isFetching:true,node:formattedNode,pauseCause:1}});dispatch(actions_closeModal(VALIDATOR_CREATE_MODAL_ID));document.getElementById('0xac85685277fba446c42272538fa64f3b28bd42a5a8b6f2295b7f2a22ee10bf35').scrollIntoView();});}).catch(function(error){// eslint-disable-next-line
...
var Validators_components_Table = __webpack_require__(106);
...
var PortalCompat = __webpack_require__(558);

// EXTERNAL MODULE: ./src/components/Modal.scss
var components_Modal = __webpack_require__(62);
...
var reduxForm = __webpack_require__(556);
...
var possibleConstructorReturn = __webpack_require__(247);
...
var es_Field = __webpack_require__(557);
...
var Form_components_Field = __webpack_require__(63);
...
var components_Metamask = __webpack_require__(65);
...
var Determine = __webpack_require__(80);
...
// Styles
// Utils
var Node_ValidatorsNodeForm=function ValidatorsNodeForm(_ref){var error=_ref.error,handleCancel=_ref.handleCancel,handleSubmit=_ref.handleSubmit,submittin=_ref.submittin;return react_default.a.createElement(components_Form_Form,{error:error,onSubmit:handleSubmit},react_default.a.createElement(components_Input,{label:"\u0425\u043E\u0441\u0442",name:"host",placeholder:"localhost"}),react_default.a.createElement(components_Input,{label:"\u041F\u043E\u0440\u0442",name:"port",placeholder:"22"}),react_default.a.createElement(components_Input,{label:"\u0418\u043C\u044F \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C",name:"username",placeholder:"root"}),react_default.a.createElement(components_Input,{label:"\u041F\u0430\u0440\u043E\u043B\u044C",name:"password",type:"password"}),console.log(error),react_default.a.createElement("div",{className:Common_default.a.Actions},react_default.a.createElement(src_components_Button,{color:color_namespaceObject.SECONDARY,onClick:handleCancel},"\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C"),react_default.a.createElement(src_components_Button,{color:gradient_namespaceObject.PURPLE,type:"submit"},"\u0420\u0430\u0437\u0432\u0435\u0440\u043D\u0443\u0442\u044C")));};var ComposedValidatorsNodeForm=Object(Recompose_esm["a" /* compose */])(Object(es["b" /* connect */])(null,{closeModal:actions_closeModal}),Object(reduxForm["a" /* default */])({form:VALIDATOR_NODE_FORM_ID,validate:validate({host:[isHost()],port:[isNumber(),max(65535),min(0)],password:[validate_required()]})}),Object(Recompose_esm["c" /* withHandlers */])({handleCancel:function handleCancel(_ref2){var closeModal=_ref2.closeModal;return function(event){return closeModal(VALIDATOR_NODE_MODAL_ID);};}}))(Node_ValidatorsNodeForm);var Node_ValidatorsNode=function ValidatorsNode(_ref3){var message=_ref3.message,vPub=_ref3.vPub,handleSubmit=_ref3.handleSubmit,isLoading=_ref3.isLoading,isSuccess=_ref3.isSuccess;return react_default.a.createElement(src_components_Modal,{classNames:{container:Common_default.a.Container},id:VALIDATOR_NODE_MODAL_ID,title:isSuccess?'Узел развёрнут! vPub:':'Развернуть узел'},!isSuccess?react_default.a.createElement(react["Fragment"],null,react_default.a.createElement(ComposedValidatorsNodeForm,{onSubmit:handleSubmit}),isLoading&&react_default.a.createElement("div",{className:Common_default.a.Loading},react_default.a.createElement("div",{className:Common_default.a.Spinner},react_default.a.createElement(src_components_Progress,null)),react_default.a.createElement(components_Typography_Typography,{className:Common_default.a.Message,variant:components_Typography_Typography.VARIANT.SUBTITLE1},message))):react_default.a.createElement(components_Typography_Typography,{className:Common_default.a.Message,variant:components_Typography_Typography.VARIANT.SUBTITLE1},vPub));};/* harmony default export */ var Node = (Object(Recompose_esm["a" /* compose */])(Object(Recompose_esm["e" /* withState */])('isLoading','setLoad',false),Object(Recompose_esm["e" /* withState */])('isSuccess','setSuccess',false),Object(Recompose_esm["e" /* withState */])('message','setMessage',''),Object(Recompose_esm["e" /* withState */])('vPub','setVPub',null),Object(Recompose_esm["c" /* withHandlers */])({handleSubmit:function handleSubmit(_ref4){var setLoad=_ref4.setLoad,setMessage=_ref4.setMessage,setSuccess=_ref4.setSuccess,setVPub=_ref4.setVPub;return function(values){return new Promise(function(resolve,reject){setLoad(true);var socket=new WebSocket('wss://api.etherus.org/nd');socket.onerror=function(error){reject(error);setLoad(false);};socket.onmessage=function(event){try{var _JSON$parse=JSON.parse(Object(lodash["get"])(event,'data')),data=_JSON$parse.data,msg=_JSON$parse.msg,result=_JSON$parse.result;setMessage(msg);if(result){setLoad(false);if(result==='success'){resolve();setSuccess();setVPub(Object(lodash["get"])(data,'vPub'));}else{reject(msg);}}}catch(error){reject(error);setLoad(false);}};socket.onopen=function(){socket.send(JSON.stringify({command:'install',data:{host:Object(lodash["get"])(values,'host','localhost'),port:Object(lodash["get"])(values,'port',22),username:Object(lodash["get"])(values,'username','root'),password:Object(lodash["get"])(values,'password')}}));};}).catch(function(error){throw new SubmissionError["a" /* default */]({_error:error});});};}}))(Node_ValidatorsNode));
...
var react_table = __webpack_require__(364);

// EXTERNAL MODULE: ./node_modules/@fortawesome/fontawesome-pro/css/all.min.css
var all_min = __webpack_require__(365);
...
var redux_thunk_es = __webpack_require__(244);

// EXTERNAL MODULE: ./node_modules/redux-form/es/reducer.js + 2 modules
var es_reducer = __webpack_require__(559);
...
// Reducers
// Services
var store_reducer=Object(redux["c" /* combineReducers */])({entities:entities_reducer,form:es_reducer["a" /* default */],services:services_reducer,views:views_reducer});var composeEnhancers=typeof window==='object'&&window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__?window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({}):redux["d" /* compose */];/* harmony default export */ var src_store = (function(history){var isSupported=false;var privateWeb3;var web3=new src_default.a(api_config.URL);if(window.ethereum||window.web3){isSupported=true;privateWeb3=new src_default.a(window.ethereum);}console.log(window.ethereum);var store=Object(redux["e" /* createStore */])(store_reducer,composeEnhancers(Object(redux["a" /* applyMiddleware */])(redux_thunk_es["a" /* default */].withExtraArgument({history:history,schema:schema_namespaceObject,web3:web3,account:privateWeb3&&new privateWeb3.eth.Contract(assets_contract,api_config.CONTRACT_ADDRESS,{from:window.ethereum.selectedAddress}),contract:new web3.eth.Contract(assets_contract,api_config.CONTRACT_ADDRESS)}))));if(isSupported){store.dispatch({type:SET_SUPPORT,isSupported:true});}web3.eth.getBlockNumber().then(function(blockNumber){Object(lodash["has"])(window,'ethereum.networkVersion')&&store.dispatch({type:SET_NETWORK_ID,networkId:Object(lodash["get"])(window,'ethereum.networkVersion')});Object(lodash["has"])(window,'ethereum.selectedAddress')&&store.dispatch({type:SET_HAS_ACCOUNT});store.dispatch({type:SET_CURRENT_BLOCK_NUMBER,blockNumber:blockNumber});});return store;});
...
//# sourceMappingURL=main.4cf9efd5.chunk.js.map