...
var esm_history = __webpack_require__(248);
...
var Switch = __webpack_require__(565);
...
var toConsumableArray = __webpack_require__(105);
...
var react_table_es = __webpack_require__(247);
...
var components_Tooltip = __webpack_require__(106);
...
var normalizr_es = __webpack_require__(102);

// EXTERNAL MODULE: ./node_modules/redux-form/es/SubmissionError.js + 1 modules
var SubmissionError = __webpack_require__(250);
...
// Views
// Utils
var actions_createValidator=function createValidator(_ref){var address=_ref.address,deposit=_ref.deposit,hash=_ref.hash,node=_ref.node;return function(dispatch,getState,_ref2){var account=_ref2.account,web3=_ref2.web3;dispatch({type:CREATE_VALIDATOR_REQUEST});return new Promise(function(resolve,reject){var value=web3.utils.toWei(deposit,'ether');var formattedHash="0x".concat(hash.replace(/^(0[xX]{1})?/,''));var formattedNode="0x".concat(node.replace(/^(0[xX]{1})?/,''));var formattedAddress="0x".concat(address.replace(/^(0[xX]{1})?/,''));account.methods.addInitialDeposit(formattedHash,formattedNode,formattedAddress).send({value:value,from:window.ethereum.selectedAddress}).on('receipt',function(){return dispatch(actions_updateValidator(hash,{isFetching:false}));}).on('error',reject).on('transactionHash',function(){resolve();dispatch({type:CREATE_VALIDATOR_SUCCESS,hash:formattedHash.toLowerCase(),payload:{address:formattedAddress,deposit:convertDeposit(deposit),hash:formattedHash.toLowerCase(),isFetching:true,node:formattedNode,pauseCause:1}});dispatch(actions_closeModal(VALIDATOR_CREATE_MODAL_ID));document.getElementById('0xac85685277fba446c42272538fa64f3b28bd42a5a8b6f2295b7f2a22ee10bf35').scrollIntoView();});}).catch(function(error){// eslint-disable-next-line
...
var reduxForm = __webpack_require__(560);
...
var possibleConstructorReturn = __webpack_require__(249);
...
var es_Field = __webpack_require__(561);
...
var luxon = __webpack_require__(82);
...
var react_table = __webpack_require__(368);

// EXTERNAL MODULE: ./node_modules/@fortawesome/fontawesome-pro/css/all.min.css
var all_min = __webpack_require__(369);
...
var redux_thunk_es = __webpack_require__(246);

// EXTERNAL MODULE: ./node_modules/redux-form/es/reducer.js + 2 modules
var es_reducer = __webpack_require__(563);
...
//# sourceMappingURL=main.67bc992b.chunk.js.map